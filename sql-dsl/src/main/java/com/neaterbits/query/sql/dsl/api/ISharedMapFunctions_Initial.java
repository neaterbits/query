...
public interface ISharedMapFunctions_Initial<
	...
	extends 
		...
		ISharedFunctions_Named_Initial<MODEL, RESULT, NAMED_RET, NAMED_INT_RET, NAMED_LONG_RET, NAMED_STRING_RET>,
		
		// alias without no-param (because of signature collision)
		ISharedFunctions_Alias_Initial<MODEL, RESULT, ALIAS_RET, ALIAS_INT_RET, ALIAS_LONG_RET, ALIAS_STRING_RET>, 
