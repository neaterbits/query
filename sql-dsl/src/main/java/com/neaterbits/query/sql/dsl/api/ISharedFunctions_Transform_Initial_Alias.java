...
public interface ISharedFunctions_Transform_Initial_Alias <
		...
		extends
			...
			ISharedFunctions_All_Transform_Alias<MODEL, RESULT, RET, LENGTH_RET, BYTE_RET, SHORT_RET, INTEGER_RET, LONG_RET, BIGINTEGER_RET, FLOAT_RET, DOUBLE_RET, BIGDECIMAL_RET, STRING_RET> {
