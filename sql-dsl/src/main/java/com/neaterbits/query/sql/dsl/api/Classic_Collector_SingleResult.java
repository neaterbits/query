...
final class Classic_Collector_SingleResult<MODEL, RESULT>
	...
	public ISharedMapFunctions_All_Undecided<
			...
			ISharedResultMap_To<MODEL, RESULT, java.util.Date, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Date, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Time, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
			...
			ISharedResultMap_To<MODEL, RESULT, java.util.Date, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Date, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Time, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>,
			...
			ISharedResultMap_OpsAndTo_Comparable_Undecided<MODEL, RESULT, java.util.Date, IClassicResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_OpsAndTo_Comparable_Undecided<MODEL, RESULT, java.util.Calendar, IClassicResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			...
			ISharedResultMap_OpsAndTo_SQLTimeType_Undecided<MODEL, RESULT, java.sql.Time, IClassicResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_OpsAndTo_SQLTimeType_Undecided<MODEL, RESULT, java.sql.Timestamp, IClassicResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			...
			ISharedResultMap_To<MODEL, RESULT, java.util.Date, IClassicResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, IClassicResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Date, IClassicResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Time, IClassicResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, IClassicResult_Mapped_Single_Undecided<MODEL, RESULT>>
