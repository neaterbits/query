...
final class WhereClauseBuilderImpl<MODEL, RESULT>
	...
	public <T, RR> ConditionClause<MODEL, RESULT, RR, AndOrLogicalClauses<MODEL, RESULT>>
		...
		return new ConditionClauseImpl<MODEL, RESULT, RR, AndOrLogicalClauses<MODEL,RESULT>>(clauseCollector, getter);
	}
	...
	public <T> StringClause<MODEL, RESULT, AndOrLogicalClauses<MODEL, RESULT>>
		...
		return new StringClauseImpl<MODEL, RESULT, AndOrLogicalClauses<MODEL,RESULT>>(clauseCollector, getter);
	}
	...
	public <T, RR> ConditionClause<MODEL, RESULT, RR, OrClauses<MODEL, RESULT>>
		...
		return new ConditionClauseImpl<MODEL, RESULT, RR, OrClauses<MODEL,RESULT>>(clauseCollector, getter);
	}
	...
	public <T> StringClause<MODEL, RESULT, OrClauses<MODEL, RESULT>> or(
		...
		return new StringClauseImpl<MODEL, RESULT, OrClauses<MODEL,RESULT>>(clauseCollector, getter);
	}
}
