...
abstract class Classic_Collector_Result<
	...
	@Override
	public <T> ISharedMap_OpsAndTo_Comparable_Named<MODEL, RESULT, Boolean, MAPPED_SOURCE_NAMED> map(IFunctionBoolean<T> getter) {
		return new ResultMapper_ExpressionList_Comparable_Named<>(new FieldExpression(getter), createMapToResult());
	}

	@Override
	public <T> ISharedMap_OpsAndTo_Comparable_Named<MODEL, RESULT, Byte, MAPPED_SOURCE_NAMED> map(IFunctionByte<T> getter) {
		return new ResultMapper_ExpressionList_Comparable_Named<>(new FieldExpression(getter), createMapToResult());
	}

	@Override
	public <T> ISharedMap_OpsAndTo_Comparable_Named<MODEL, RESULT, Short, MAPPED_SOURCE_NAMED> map(IFunctionShort<T> getter) {
		return new ResultMapper_ExpressionList_Comparable_Named<>(new FieldExpression(getter), createMapToResult());
	}

	@Override
	public <T> ISharedMap_OpsAndTo_Comparable_Named<MODEL, RESULT, Integer, MAPPED_SOURCE_NAMED> map(IFunctionInteger<T> getter) {
		return new ResultMapper_ExpressionList_Comparable_Named<>(new FieldExpression(getter), createMapToResult());
	}

	@Override
	public <T> ISharedMap_OpsAndTo_Comparable_Named<MODEL, RESULT, Long, MAPPED_SOURCE_NAMED> map(IFunctionLong<T> getter) {
		return new ResultMapper_ExpressionList_Comparable_Named<>(new FieldExpression(getter), createMapToResult());
	}

	@Override
	public <T> ISharedMap_OpsAndTo_Comparable_Named<MODEL, RESULT, BigInteger, MAPPED_SOURCE_NAMED> map(IFunctionBigInteger<T> getter) {
		return new ResultMapper_ExpressionList_Comparable_Named<>(new FieldExpression(getter), createMapToResult());
	}

	@Override
	public <T> ISharedMap_OpsAndTo_Comparable_Named<MODEL, RESULT, Float, MAPPED_SOURCE_NAMED> map(IFunctionFloat<T> getter) {
		return new ResultMapper_ExpressionList_Comparable_Named<>(new FieldExpression(getter), createMapToResult());
	}
	
	@Override
	public <T> ISharedMap_OpsAndTo_Comparable_Named<MODEL, RESULT, Double, MAPPED_SOURCE_NAMED> map(IFunctionDouble<T> getter) {
		return new ResultMapper_ExpressionList_Comparable_Named<>(new FieldExpression(getter), createMapToResult());
	}
	
	@Override
	public <T> ISharedMap_OpsAndTo_Comparable_Named<MODEL, RESULT, BigDecimal, MAPPED_SOURCE_NAMED> map(IFunctionBigDecimal<T> getter) {
		return new ResultMapper_ExpressionList_Comparable_Named<>(new FieldExpression(getter), createMapToResult());
	}

	@Override
	public <T> ISharedMap_OpsAndTo_String_Named<MODEL, RESULT, MAPPED_SOURCE_NAMED> map(IFunctionString<T> getter) {
