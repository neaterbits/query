...
public class MappedJoinWhereAndTest extends GEN_BaseTestCase {
    ...
    public void testMappedSingleNamed() {
    	verifyIsNotCompilable(
    			...
    			".and(l::getHectares).isLessThan(new BigDecimal(\"200.5\"))");
    	...
    	verifyIsCompilable(
    			...
    			".innerJoin(Farm::getLandPlots)" +
    			".where(LandPlot::getHectares).isGreaterThan(new BigDecimal(\"100.5\"))" +
    			".and(LandPlot::getHectares).isLessThan(new BigDecimal(\"200.5\"))");
    	...
    	final SingleBuilt<FarmLand> query
    		= select.one(FarmLand.class)
    			...
    			.and(LandPlot::getHectares).isLessThan(new BigDecimal("345.43"))
    			.build();
    ...
    public void testMappedSingleNamed_Farm_Left() {
    	...
    	final SingleBuilt<FarmLand> query
    		= select.one(FarmLand.class)
    			...
    			.where(LandPlot::getHectares).isLessThan(new BigDecimal("40.6"))
    			.and(LandPlot::getHectares).isGreaterOrEqualTo(new BigDecimal("40.5"))
    			.build();
    	
    	store(farm1, farm2, land4)
    	.remove(land1, land2, land3)
    	.checkOne(query, () -> new FarmLand("Farm2", new BigDecimal("40.5")));
    }
    ...
    public void testMappedSingleAlias() {
    	...
    	final SingleBuilt<FarmLand> query
    		= select.one(FarmLand.class)
    			...
    			.and(l::getHectares).isLessThan(new BigDecimal("345.43"))
    			.build();
    ...
    public void testMappedSingleAlias_Farm_Left() {
    	...
    	final SingleBuilt<FarmLand> query
    		= select.one(FarmLand.class)
    			...
    			.where(l::getHectares).isLessThan(new BigDecimal("40.6"))
    			.and(l::getHectares).isGreaterOrEqualTo(new BigDecimal("40.5"))
    			.build();
    ...
    public void testMappedMultiNamed() {
    	...
    	final LandPlot land3 = new Uncultivated(new BigDecimal("100.5"));
    	final LandPlot land4 = new Uncultivated(new BigDecimal("345.43"));
    	final LandPlot land5 = new Uncultivated(new BigDecimal("473.3"));
    	...
    	final MultiBuilt<FarmLand> query
    		= select.list(FarmLand.class)
				...
				.map(LandPlot::getHectares) .to(FarmLand::setHectares)
    			.innerJoin(Farm::getLandPlots)
    			.where(LandPlot::getHectares).isGreaterThan(new BigDecimal("40.49"))
    			.and(LandPlot::getHectares).isLessThan(new BigDecimal("345.43"))
    			.build();
    ...
    public void testMappedMultiAlias() {
    	...
    	final MultiBuilt<FarmLand> query
    		= select.list(FarmLand.class)
				...
				.map(l::getHectares).to(FarmLand::setHectares)
    			.innerJoin(f::getLandPlots, l)
    			.where(l::getHectares).isGreaterThan(new BigDecimal("40.49"))
    			.and(l::getHectares).isLessThan(new BigDecimal("345.43"))
    			.build();
