...
final class GEN_TestCodeGenerator {
	...
	private static class CodeWriter implements AutoCloseable {
		
		private int indent;
		
		private final Writer writer;

		CodeWriter(OutputStream out) {
		...
		CodeWriter indent() throws IOException {
			return append(StringUtils.indent(indent * 4));
		}
		
		
		CodeWriter newLine() throws IOException {
			writer.append('\n');
			
			return this;
		}

		CodeWriter append(String s) throws IOException {
		...
		CodeWriter append(char c) throws IOException {
