...
abstract class Collector_Or_Named<
	...
	private <T, RR extends Comparable<RR>> ISharedComparison_Comparable_Common_All<MODEL, RESULT, RR, OR_CLAUSES>
	...
	private <T, RR> ISharedComparison_SQLTimeType_All<MODEL, RESULT, RR, OR_CLAUSES> orClassImplSQLTimeType(Function<T, RR> getter) {
			
		return new Collector_Condition_SQLTimeType<>(this, makeGetterExpression(getter));
	}
	
	private <T> ISharedComparison_ByteArray_All<MODEL, RESULT, OR_CLAUSES> orClassImplByteArray(Function<T, byte []> getter) {
		
		return new Collector_Condition_ByteArray<>(this, makeGetterExpression(getter));
	}

	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, Boolean, OR_CLAUSES> or(IFunctionBoolean<T> getter) {
		return orClassImplComparable(getter);
	}

	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, Byte, OR_CLAUSES> or(IFunctionByte<T> getter) {
		return orClassImplComparable(getter);
	}

	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, Short, OR_CLAUSES> or(IFunctionShort<T> getter) {
		return orClassImplComparable(getter);
	}

	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, Integer, OR_CLAUSES> or(IFunctionInteger<T> getter) {
		return orClassImplComparable(getter);
	}

	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, Long, OR_CLAUSES> or(IFunctionLong<T> getter) {
		return orClassImplComparable(getter);
	}
	
	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, BigInteger, OR_CLAUSES> or(IFunctionBigInteger<T> getter) {
		return orClassImplComparable(getter);
	}
	
	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, Float, OR_CLAUSES> or(IFunctionFloat<T> getter) {
		return orClassImplComparable(getter);
	}

	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, Double, OR_CLAUSES> or(IFunctionDouble<T> getter) {
		return orClassImplComparable(getter);
	}
	
	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, BigDecimal, OR_CLAUSES> or(IFunctionBigDecimal<T> getter) {
		return orClassImplComparable(getter);
	}

	@Override
	public final <T> ISharedComparison_Comparable_String_All<MODEL, RESULT, OR_CLAUSES> or(IFunctionString<T> getter) {
		return orClassImplString(new FieldExpression(getter));
	}

	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, java.util.Date, OR_CLAUSES> or(IFunctionDate<T> getter) {
		return orClassImplComparable(getter);
	}

	@Override
	public final <T> ISharedComparison_Comparable_Common_All<MODEL, RESULT, java.util.Calendar, OR_CLAUSES> or(IFunctionCalendar<T> getter) {
		return orClassImplComparable(getter);
	}

	@Override
	public final <T> ISharedComparison_SQLTimeType_All<MODEL, RESULT, java.sql.Date, OR_CLAUSES> or(IFunctionSQLDate<T> getter) {
		return orClassImplSQLTimeType(getter);
	}
	
	@Override
	public final <T> ISharedComparison_SQLTimeType_All<MODEL, RESULT, java.sql.Time, OR_CLAUSES> or(IFunctionSQLTime<T> getter) {
		return orClassImplSQLTimeType(getter);
	}

	@Override
	public final <T> ISharedComparison_SQLTimeType_All<MODEL, RESULT, java.sql.Timestamp, OR_CLAUSES> or(IFunctionSQLTimestamp<T> getter) {
		return orClassImplSQLTimeType(getter);
	}
	
	@Override
	public final <T> ISharedComparison_ByteArray_All<MODEL, RESULT, OR_CLAUSES> or(IFunctionByteArray<T> getter) {
	...
	public final OR_CLAUSES orNest(
			ISharedNested_And_Consumer_Named<MODEL, RESULT, NESTED_AND_CLAUSES> orBuilder) {
	...
	public final ISharedFunctions_Transform_Initial_Named<
		...
		final ISharedCollector_Functions_Callback<MODEL, RESULT, OR_CLAUSES> cb = new ISharedCollector_Functions_Callback<MODEL, RESULT, OR_CLAUSES>() {
			...
			@Override
			public ISharedComparison_Comparable_Common_All<MODEL, RESULT, Comparable<?>, OR_CLAUSES> onComparable(Expression expression) {

				return (ISharedComparison_Comparable_Common_All)orClassImplComparable(expression);
			}

			@Override
			public ISharedComparison_Comparable_String_Base<MODEL, RESULT, OR_CLAUSES> onString(Expression expression) {
