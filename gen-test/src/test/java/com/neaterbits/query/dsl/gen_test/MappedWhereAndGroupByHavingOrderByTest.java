...
public class MappedWhereAndGroupByHavingOrderByTest extends GEN_BaseTestCase {
    ...
    public void testMappedMultiNamed() {
    	...
    	final Farm other3_alt = new Farm("Alt_Other3", "alt_other3", "sub2");
    	...
    	.checkListOrdered(
    			...
    			() -> expected( 
					...
					new FarmInfo(null, "alt_other3", "sub2")
