...
public class MappedWhereAndFunctionGroupByHavingOrderByTest extends GEN_BaseTestCase {
    ...
    public void testMappedMultiNamed() {
    	...
    	final Farm other3_alt = new Farm("Alt_Other3", "alt_other_id3", "sub2");
    	...
    	store(other5, farm2, farm4, other3_alt, other2, other4, farm3, other1, farm5, farm1, other3)
    	.checkListOrdered(
    			query,
    			
    			() -> expected( 
					new FarmInfo(null, "other_id3", "sub2"),
					new FarmInfo(null, "alt_other_id3", "sub2")
