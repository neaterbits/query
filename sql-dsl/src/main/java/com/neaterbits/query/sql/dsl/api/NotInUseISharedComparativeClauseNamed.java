...
public interface NotInUseISharedComparativeClauseNamed<MODEL, RESULT, R extends Comparable<R>, L extends ISharedLogicalClauses<MODEL, RESULT>>
	extends ISharedClauseComparableCommonAll<MODEL, RESULT, R, L>,
	        ISharedClauseConditionNamed<MODEL, RESULT, R, L> {
