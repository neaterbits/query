...
public interface ISharedSubOperandsBuilder_String_Next_Undecided<MODEL, RESULT, AFTER extends ISharedFunction_After<MODEL, RESULT>>
	...
	extends 
		...
		ISharedOperands_String_Undecided_All<
			...
			ISharedSubOperandsBuilder_String_Next_Undecided<MODEL, RESULT, AFTER>> {
}
