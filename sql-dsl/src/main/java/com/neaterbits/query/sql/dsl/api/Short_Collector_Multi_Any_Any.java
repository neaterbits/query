...
final class Short_Collector_Multi_Any_Any<MODEL, RESULT>
	...
	public ISharedMapFunctions_All_Undecided<
				...
				ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				
				ISharedResultMap_To<MODEL, RESULT, Byte, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Short, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, BigInteger, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Float, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Double, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, BigDecimal, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, String, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Date, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Date, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Time, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, IShortResult_Mapped_Multi_Named<MODEL, RESULT>>,
				...
				ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				
				ISharedResultMap_To<MODEL, RESULT, Byte, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Short, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, BigInteger, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Float, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Double, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, BigDecimal, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, String, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Date, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Date, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Time, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, IShortResult_Mapped_Multi_Alias<MODEL, RESULT>>,
				...
				ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				
				ISharedResultMap_To<MODEL, RESULT, Byte, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Short, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, BigInteger, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Float, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, Double, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, BigDecimal, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, String, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Date, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Date, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Time, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, IShortResult_Mapped_Multi_Undecided<MODEL, RESULT>>
