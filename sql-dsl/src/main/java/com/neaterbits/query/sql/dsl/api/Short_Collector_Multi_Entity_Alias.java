...
final class Short_Collector_Multi_Entity_Alias<MODEL, RESULT>
	...
	public ISharedFunctions_Transform_Initial_Alias<
			...
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, Integer, ISQLLogical_AndOr_MultiEntity_Alias<MODEL, RESULT>>,
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, Long, ISQLLogical_AndOr_MultiEntity_Alias<MODEL, RESULT>>,
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, BigInteger, ISQLLogical_AndOr_MultiEntity_Alias<MODEL, RESULT>>,
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, Float, ISQLLogical_AndOr_MultiEntity_Alias<MODEL, RESULT>>,
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, Double, ISQLLogical_AndOr_MultiEntity_Alias<MODEL, RESULT>>,
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, BigDecimal, ISQLLogical_AndOr_MultiEntity_Alias<MODEL, RESULT>>,
			ISharedCondition_Comparable_String_All<MODEL, RESULT, ISQLLogical_AndOr_MultiEntity_Alias<MODEL, RESULT>>> where() {
	...
	public ISharedFunctions_Transform_Initial_Alias<
			...
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, BigInteger, ISQLLogical_Or_MultiEntity_Alias<MODEL, RESULT>>,
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, Float, ISQLLogical_Or_MultiEntity_Alias<MODEL, RESULT>>,
	...
	public ISharedFunctions_Transform_Initial_Alias<
			...
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, BigInteger, ISQLLogical_And_MultiEntity_Alias<MODEL, RESULT>>,
			ISharedCondition_Comparable_Common_All<MODEL, RESULT, Float, ISQLLogical_And_MultiEntity_Alias<MODEL, RESULT>>,
