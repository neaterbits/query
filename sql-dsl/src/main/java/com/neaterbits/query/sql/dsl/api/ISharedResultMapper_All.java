...
public interface ISharedResultMapper_All<MODEL, RESULT, 
	...
	ISharedMapFunctions_Initial<
				...
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, Long, NAMED_SOURCE>,
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, Byte, NAMED_SOURCE>,
				...
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, Long, NAMED_SOURCE>,
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, BigInteger, NAMED_SOURCE>,
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, Float, NAMED_SOURCE>,
				...
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, java.util.Date, NAMED_SOURCE>,
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, java.util.Calendar, NAMED_SOURCE>,
				ISharedResultMap_OpsAndTo_NumericSQLTimeType_Named<MODEL, RESULT, java.sql.Date, NAMED_SOURCE>,
				ISharedResultMap_OpsAndTo_NumericSQLTimeType_Named<MODEL, RESULT, java.sql.Time, NAMED_SOURCE>,
				ISharedResultMap_OpsAndTo_NumericSQLTimeType_Named<MODEL, RESULT, java.sql.Timestamp, NAMED_SOURCE>,
