...
final class SQL_Collector_And_MultiMapped_Named<MODEL, RESULT>
	...
	SQL_Collector_And_MultiMapped_Named(SQL_Collector_WhereOrJoin_Named_Base<MODEL, RESULT, ?, ?, ?, ?, ?> last) {
		super(last);
	}

	SQL_Collector_And_MultiMapped_Named(Collector_Conditions_Base<MODEL, RESULT> qe) {
		super(qe);
	}
}
