...
final class Classic_Collector_WhereOrJoin_ProcessResult_Alias<MODEL, RESULT>
	...
	Classic_Collector_And_Alias<MODEL, RESULT, IClassicLogical_And_NonProcessResult_Alias<MODEL, RESULT>> createNestedAnd(
			Classic_Collector_Or_Alias<MODEL, RESULT, IClassicLogical_Or_ProcessResult_Alias<MODEL, RESULT>> orClauses) {
	...
	Classic_Collector_Or_Alias<MODEL, RESULT, IClassicLogical_Or_NonProcessResult_Alias<MODEL, RESULT>> createNestedOr(
			Classic_Collector_And_Alias<MODEL, RESULT, IClassicLogical_And_ProcessResult_Alias<MODEL, RESULT>> andClauses) {
