...
final class Classic_Collector_MapToResult_Single<MODEL, RESULT>
	...
	*/
	...
	public ISharedMapFunctions_Initial<
				...
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, Long, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, Byte, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				...
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, Long, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, BigInteger, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, Float, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				...
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, java.util.Date, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_Numeric_Named<MODEL, RESULT, java.util.Calendar, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_NumericSQLTimeType_Named<MODEL, RESULT, java.sql.Date, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_NumericSQLTimeType_Named<MODEL, RESULT, java.sql.Time, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_NumericSQLTimeType_Named<MODEL, RESULT, java.sql.Timestamp, IClassicResult_Mapped_Single_Named<MODEL, RESULT>>,
				...
				ISharedResultOps_Numeric_Alias<MODEL, RESULT, Long, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>,
				ISharedResultOps_Numeric_Alias<MODEL, RESULT, Byte, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>,
				...
				ISharedResultOps_Numeric_Alias<MODEL, RESULT, Long, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>, 
				ISharedResultOps_Numeric_Alias<MODEL, RESULT, BigInteger, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>, 
				ISharedResultOps_Numeric_Alias<MODEL, RESULT, Float, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>, 
				...
				ISharedResultOps_Numeric_Alias<MODEL, RESULT, java.util.Date, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>,
				ISharedResultOps_Numeric_Alias<MODEL, RESULT, java.util.Calendar, IClassicResult_Mapped_Single_Alias<MODEL, RESULT>>,
