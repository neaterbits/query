...
final class Short_Collector_Single_Aggregate_Alias_TypedJoin<MODEL, RESULT> 
	...
	Short_Collector_Single_Aggregate_Alias_TypedJoin(Collector_Conditions_Initial<MODEL, RESULT, ISharedProcessResult_After_GroupBy_Named<MODEL, RESULT>> last) {
		super(last);
	}
	...
	public final ISharedFunctions_Transform_Initial_Alias<
			...
			ISharedComparison_Comparable_String_All<MODEL, RESULT, ISQLLogical_AndOr_SingleResult_Alias<MODEL, RESULT>>> where() {
