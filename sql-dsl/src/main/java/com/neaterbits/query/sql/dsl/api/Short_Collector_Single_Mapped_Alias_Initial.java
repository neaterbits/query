...
final class Short_Collector_Single_Mapped_Alias_Initial<MODEL, RESULT> 
	...
	*/
	...
	public ISharedMapFunctions_All_Alias<
				...
				ISharedResultMap_OpsAndTo_Numeric_Alias<MODEL, RESULT, Byte, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
				...
				ISharedResultMap_OpsAndTo_Numeric_Alias<MODEL, RESULT, Long, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_Numeric_Alias<MODEL, RESULT, BigInteger, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_Numeric_Alias<MODEL, RESULT, Float, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
				...
				ISharedResultMap_OpsAndTo_Numeric_Alias<MODEL, RESULT, java.util.Date, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_Numeric_Alias<MODEL, RESULT, java.util.Calendar, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_NumericSQLTimeType_Alias<MODEL, RESULT, java.sql.Date, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_NumericSQLTimeType_Alias<MODEL, RESULT, java.sql.Time, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
				ISharedResultMap_OpsAndTo_NumericSQLTimeType_Alias<MODEL, RESULT, java.sql.Timestamp, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
