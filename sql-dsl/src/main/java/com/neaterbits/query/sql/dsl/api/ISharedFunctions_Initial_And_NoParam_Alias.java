...
public interface ISharedFunctions_Initial_And_NoParam_Alias<
		...
		extends 
			...
			ISharedFunctions_Arithmetic_NoParam_Alias<MODEL, RESULT, RET, BYTE_RET, SHORT_RET, INTEGER_RET, LONG_RET, BIGINTEGER_RET, FLOAT_RET, DOUBLE_RET, BIGDECIMAL_RET>,
			ISharedFunctions_String_NoParam_Alias<MODEL, RESULT, RET, LENGTH_RET, STRING_RET> 
