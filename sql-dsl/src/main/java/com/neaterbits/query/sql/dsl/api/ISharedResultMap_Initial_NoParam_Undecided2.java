...
public interface ISharedResultMap_Initial_NoParam_Undecided2<
	MODEL, 
	RESULT,
	...
	extends 
	ISharedResultMap_Initial_NoParam_Undecided1<MODEL, RESULT, NAMED_RET, ALIAS_RET, UNDECIDED_RET>,
	...
	ISharedMapFunctions_All_Undecided<
		...
		ISharedResultMap_To<MODEL, RESULT, Long, 		 NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Long, 		 NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Integer, 	 NAMED_RET>,
		
		ISharedResultMap_To<MODEL, RESULT, Byte, 	 NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Short, 	 NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Integer, 	 NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Long, 		 NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, BigInteger, NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Float, 	 NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Double, 	 NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, BigDecimal, NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, String, 	 NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.util.Date, NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.sql.Date, NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.sql.Time, NAMED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, NAMED_RET>,
		...
		ISharedResultMap_To<MODEL, RESULT, Long, 		 ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, Long, 		 ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, Integer, 	 ALIAS_RET>,
		
		ISharedResultMap_To<MODEL, RESULT, Byte, 	 ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, Short, 	 ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, Integer, 	 ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, Long, 		 ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, BigInteger, ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, Float, 	 ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, Double, 	 ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, BigDecimal, ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, String, 	 ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.util.Date, ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.sql.Date, ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.sql.Time, ALIAS_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, ALIAS_RET>,
		...
		ISharedResultMap_To<MODEL, RESULT, Long, 		 UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Long, 		 UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Integer, 	 UNDECIDED_RET>,
		
		ISharedResultMap_To<MODEL, RESULT, Byte, 	 UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Short, 	 UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Integer, 	 UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Long, 		 UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, BigInteger, UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Float, 	 UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, Double, 	 UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, BigDecimal, UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, String, 	 UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.util.Date, UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.sql.Date, UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.sql.Time, UNDECIDED_RET>,
		ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, UNDECIDED_RET>
	> 
