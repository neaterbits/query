...
public interface ISharedConditionFunctions_Numeric_Named<
	MODEL,
	RESULT,
	...
	extends 
		...
		// ISharedFunctions_Aggregate_Named_All<SUM_LONG_RET, COUNT_RET, BYTE_RET, SHORT_RET, INT_RET, LONG_RET, BIGINTEGER_RET, FLOAT_RET, DOUBLE_RET, BIGDECIMAL_RET, DATE_RET>,
		...
		ISharedFunctions_Arithmetic_NoParam_Base<MODEL, RESULT,
			...
			ISharedConditionFunctions_Numeric_Named<MODEL, RESULT, RET,
