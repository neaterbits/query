...
abstract class Short_Collector_Initial_Single_Any_Any_Base<MODEL, RESULT>
	...
	*/
	...
	public ISharedMapFunctions_All_Undecided<
			...
			ISharedResultMap_OpsAndTo_Comparable_Named<MODEL, RESULT, java.util.Date, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_OpsAndTo_Comparable_Named<MODEL, RESULT, java.util.Calendar, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_OpsAndTo_SQLTimeType_Named<MODEL, RESULT, java.sql.Date, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_OpsAndTo_SQLTimeType_Named<MODEL, RESULT, java.sql.Time, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_OpsAndTo_SQLTimeType_Named<MODEL, RESULT, java.sql.Timestamp, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			...
			ISharedResultMap_To<MODEL, RESULT, java.util.Date, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Date, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Time, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, IShortResult_Mapped_Single_Named<MODEL, RESULT>>,
			...
			ISharedResultMap_OpsAndTo_String_Alias<MODEL, RESULT, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			...
			ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			
			ISharedResultMap_To<MODEL, RESULT, Byte, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Short, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, BigInteger, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Float, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Double, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, BigDecimal, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, String, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.util.Date, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Date, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Time, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, IShortResult_Mapped_Single_Alias<MODEL, RESULT>>,
			...
			ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			
			ISharedResultMap_To<MODEL, RESULT, Byte, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Short, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Integer, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Long, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, BigInteger, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Float, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, Double, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, BigDecimal, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, String, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.util.Date, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Date, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Time, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>,
			ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, IShortResult_Mapped_Single_Undecided<MODEL, RESULT>>
