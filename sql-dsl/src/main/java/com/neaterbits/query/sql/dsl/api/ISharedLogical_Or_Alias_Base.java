...
public interface ISharedLogical_Or_Alias_Base<
    ...
    ISharedCondition_Equality_All<MODEL, RESULT, Integer, OR_CLAUSES> or(ISupplierInteger getter);

    ISharedCondition_Equality_All<MODEL, RESULT, Long, OR_CLAUSES> or(ISupplierLong getter);
