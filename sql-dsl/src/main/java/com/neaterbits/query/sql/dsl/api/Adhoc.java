...
public interface Adhoc {
    ...
    public static <T> IAdhocNumericNamedResult<Void, Integer, T> sum(IFunctionShort<T> field) {
    	return AdhocImpl.adhocImpl.sum(field);
    }
	
    public static <T> IAdhocNumericNamedResult<Void, Integer, T> sum(IFunctionInteger<T> field) {
    	return AdhocImpl.adhocImpl.sum(field);
    }

    public static <T> IAdhocNumericNamedResult<Void, Long, T> sum(IFunctionLong<T> field) {
    	return AdhocImpl.adhocImpl.sum(field);
    }

    public static <T> IAdhocNumericNamedResult<Void, BigDecimal, T> sum(IFunctionBigDecimal<T> field) {
    	return AdhocImpl.adhocImpl.sum(field);
    }

    /* Max */
    public static <T> IAdhocNumericNamedResult<Void, Short, T> max(IFunctionShort<T> field) {
    	return AdhocImpl.adhocImpl.max(field);
    }
	
    public static <T> IAdhocNumericNamedResult<Void, Integer, T> max(IFunctionInteger<T> field) {
    	return AdhocImpl.adhocImpl.max(field);
    }

    public static <T> IAdhocNumericNamedResult<Void, Long, T> max(IFunctionLong<T> field) {
    	return AdhocImpl.adhocImpl.max(field);
    }

    public static <T> IAdhocNumericNamedResult<Void, BigDecimal, T> max(IFunctionBigDecimal<T> field) {
    	return AdhocImpl.adhocImpl.max(field);
    }
