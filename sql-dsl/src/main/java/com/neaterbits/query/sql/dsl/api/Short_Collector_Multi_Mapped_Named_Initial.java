...
final class Short_Collector_Multi_Mapped_Named_Initial<MODEL, RESULT>
	...
	public ISharedFunctions_Transform_Initial_Named<
			...
			ISharedComparison_Comparable_Common_All_Compilable<MODEL, RESULT, Integer, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>,
			
			ISharedComparison_Comparable_Common_All_Compilable<MODEL, RESULT, Byte, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All_Compilable<MODEL, RESULT, Short, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All_Compilable<MODEL, RESULT, Integer, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All_Compilable<MODEL, RESULT, Long, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All_Compilable<MODEL, RESULT, BigInteger, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All_Compilable<MODEL, RESULT, Float, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All_Compilable<MODEL, RESULT, Double, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>, 
			ISharedComparison_Comparable_Common_All_Compilable<MODEL, RESULT, BigDecimal, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_String_All_Compilable<MODEL, RESULT, ISQLLogical_AndOr_MultiMapped_Named<MODEL, RESULT>>
		> where() {
