...
abstract class Classic_Collector_WhereOrJoin_Named<
	...
	Classic_Collector_WhereOrJoin_Named(BaseQueryEntity<MODEL> last) {
		super(last);
	}
	...
	// ------------------------  WHERE ------------------------
	@Override
	public final <T> ISharedCondition_Comparable_Common_All_Compilable<MODEL, RESULT, Integer, IClassicLogical_And_Or_Named<MODEL, RESULT>> where(IFunctionInteger<T> getter) {
	...
	@Override
	public final <T> ISharedCondition_Comparable_Common_All_Compilable<MODEL, RESULT, Long, IClassicLogical_And_Or_Named<MODEL, RESULT>> where(IFunctionLong<T> getter) {
	...
	@Override
	public final <T, E extends Enum<E>> ISharedCondition_Equality_All<MODEL, RESULT, E, IClassicLogical_And_Or_Named<MODEL, RESULT>> where(IFunctionEnum<T, E> getter) {
	...
	@Override
	public final <T> ISharedCondition_Comparable_String_All_Compilable<MODEL, RESULT, IClassicLogical_And_Or_Named<MODEL, RESULT>> where(StringFunction<T> getter) {
	...
	public final ISharedFunctions_Named_Initial<
		...
		final ISharedCollector_Functions_Callback_Named<MODEL, RESULT, IClassicLogical_And_Or_Named<MODEL, RESULT>> cb
			...
			public ISharedCondition_Comparable_String_Base<MODEL, RESULT, IClassicLogical_And_Or_Named<MODEL, RESULT>>
				...
				return new Collector_Condition_String<MODEL, RESULT, IClassicLogical_And_Or_Named<MODEL, RESULT>> (Classic_Collector_WhereOrJoin_Named.this, functions, makeGetter(getter));
			}
		};
	...
	@Override
	public final <T> ISharedCondition_Comparable_Common_All<MODEL, RESULT, Integer, IClassicLogical_And_Named<MODEL, RESULT>> and(IFunctionInteger<T> getter) {
		return andClassImplComparative(getter);
	}

	@Override
	public final <T> ISharedCondition_Comparable_Common_All<MODEL, RESULT, Long, IClassicLogical_And_Named<MODEL, RESULT>> and(IFunctionLong<T> getter) {
		return andClassImplComparative(getter);
	}

	@Override
	public final <T> ISharedCondition_Comparable_String_All<MODEL, RESULT, IClassicLogical_And_Named<MODEL, RESULT>> and(StringFunction<T> getter) {
	...
	@Override
	public final <T> ISharedCondition_Comparable_Common_All<MODEL, RESULT, Integer, IClassicLogical_Or_Named<MODEL, RESULT>> or(IFunctionInteger<T> getter) {
		return orClassImplComparable(getter);
	}

	
	@Override
	public final <T> ISharedCondition_Comparable_Common_All<MODEL, RESULT, Long, IClassicLogical_Or_Named<MODEL, RESULT>> or(IFunctionLong<T> getter) {
		return orClassImplComparable(getter);
	}


	@Override
	public final <T> ISharedCondition_Comparable_String_All<MODEL, RESULT, IClassicLogical_Or_Named<MODEL, RESULT>> or(StringFunction<T> getter) {
	...
	private <RR extends Comparable<RR>,
		...
		ISharedCondition_Equality_All<MODEL, RESULT, RR, OR_CLAUSES> orAliasImpl(Classic_Collector_WhereOrJoin_Named<MODEL, RESULT, ?> last, Supplier<RR> getter) {
	...
	@Override
	public final IClassicLogical_And_Named<MODEL, RESULT> andNest(ISharedNestedOrConsumerNamed<MODEL, RESULT, IClassicLogical_Or_Named<MODEL, RESULT>> orBuilder) {
		return addNestedOrImpl(orBuilder);
	}

	@Override
	public final IClassicLogical_Or_Named<MODEL, RESULT> orNest(ISharedNestedAndConsumerNamed<MODEL, RESULT, IClassicLogical_And_Named<MODEL, RESULT>> andBuilder) {
