		...
		IShortLogical_WhereOrJoin_MultiEntity_Named<MODEL, RESULT, JOIN_TYPE>
{
	...
	public ISharedFunctions_Transform_Initial_Named<
				...
				ISharedComparison_Comparable_Common_All<MODEL, RESULT, Integer, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,

				ISharedComparison_Comparable_Common_All<MODEL, RESULT, Byte, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,
				ISharedComparison_Comparable_Common_All<MODEL, RESULT, Short, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,
				/*
				...
				*/
				ISharedComparison_Comparable_Common_All<MODEL, RESULT, Integer, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,
				ISharedComparison_Comparable_Common_All<MODEL, RESULT, Long, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,
				ISharedComparison_Comparable_Common_All<MODEL, RESULT, BigInteger, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,
				ISharedComparison_Comparable_Common_All<MODEL, RESULT, Float, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,
				//ISharedCondition_Comparable_Common_All<MODEL, RESULT, BigInteger, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,
				ISharedComparison_Comparable_Common_All<MODEL, RESULT, Double, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,
				ISharedComparison_Comparable_Common_All<MODEL, RESULT, BigDecimal, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>,
				ISharedComparison_Comparable_String_All<MODEL, RESULT, ISQLLogical_Or_MultiEntity_Named<MODEL, RESULT>>/*,
	...
	public ISharedFunctions_Transform_Initial_Named<
			...
			ISharedComparison_Comparable_Common_All<MODEL, RESULT, Integer, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>,

			ISharedComparison_Comparable_Common_All<MODEL, RESULT, Byte, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All<MODEL, RESULT, Short, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All<MODEL, RESULT, Integer, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All<MODEL, RESULT, Long, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All<MODEL, RESULT, BigInteger, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All<MODEL, RESULT, Float, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All<MODEL, RESULT, Double, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_Common_All<MODEL, RESULT, BigDecimal, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>,
			ISharedComparison_Comparable_String_All<MODEL, RESULT, ISQLLogical_And_MultiEntity_Named<MODEL, RESULT>>> and() {
