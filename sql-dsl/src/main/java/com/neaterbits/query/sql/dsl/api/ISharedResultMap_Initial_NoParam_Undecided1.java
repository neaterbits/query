...
public interface ISharedResultMap_Initial_NoParam_Undecided1<MODEL, RESULT, 
	...
	extends ISharedResultMap_Initial_Named<MODEL, RESULT, NAMED_SOURCE>,
			ISharedResultMap_Initial_Alias<MODEL, RESULT, ALIAS_SOURCE>
	...
	ISharedMapFunctions_All_Undecided<
				...
				ISharedResultMap_To<MODEL, RESULT, Long, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Long, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Integer, NAMED_SOURCE>,
				
				ISharedResultMap_To<MODEL, RESULT, Byte, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Short, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Integer, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Long, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, BigInteger, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Float, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Double, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, BigDecimal, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, String,  NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Date, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Date, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Time, NAMED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, NAMED_SOURCE>,
				...
				ISharedResultMap_To<MODEL, RESULT, Long, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Long, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Integer, ALIAS_SOURCE>,
				
				ISharedResultMap_To<MODEL, RESULT, Byte, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Short, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Integer, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Long, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, BigInteger, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Float, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Double, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, BigDecimal, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, String,  ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Date, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Date, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Time, ALIAS_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, ALIAS_SOURCE>,
				...
				ISharedResultMap_To<MODEL, RESULT, Long, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Long, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Integer, UNDECIDED_SOURCE>,
				
				ISharedResultMap_To<MODEL, RESULT, Byte, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Short, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Integer, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Long, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, BigInteger, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Float, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, Double, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, BigDecimal, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, String,  UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Date, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.util.Calendar, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Date, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Time, UNDECIDED_SOURCE>,
				ISharedResultMap_To<MODEL, RESULT, java.sql.Timestamp, UNDECIDED_SOURCE>				
	>
