...
public interface ISharedFunctions_NumericResult_Named<
		MODEL,
		RESULT,
	...
	extends ISharedFunctions_Arithmetic_Named_All<
			MODEL,
			RESULT,
			RET,
		...
		ISharedFunctions_String_NumericResult_Named<MODEL, RESULT, RET, LENGTH_RET> {
