...
/*
	...
	*/
	...
	public ISharedNumericFunctions_Initial<
				...
				NO_PARAM_NAMED_SHORT_RET, NO_PARAM_NAMED_INT_RET, NO_PARAM_NAMED_LONG_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_BIGDECIMAL_RET, NO_PARAM_NAMED_DATE_RET,
				NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_COUNT_RET,
				NO_PARAM_NAMED_SHORT_RET, NO_PARAM_NAMED_INT_RET, NO_PARAM_NAMED_LONG_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_BIGDECIMAL_RET, NO_PARAM_NAMED_DATE_RET,
				
				NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_COUNT_RET,
				NO_PARAM_ALIAS_SHORT_RET, NO_PARAM_ALIAS_INT_RET, NO_PARAM_ALIAS_LONG_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_BIGDECIMAL_RET, NO_PARAM_ALIAS_DATE_RET,
				NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_COUNT_RET,
				NO_PARAM_ALIAS_SHORT_RET, NO_PARAM_ALIAS_INT_RET, NO_PARAM_ALIAS_LONG_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_BIGDECIMAL_RET, NO_PARAM_ALIAS_DATE_RET
				> abs() {
	...
	*/
	...
	public ISharedNumericFunctions_Initial<
				...
				NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET,
				NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET,
				NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_DOUBLE_RET,
				
				NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET,
				NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET,
				NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET,
				NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_DOUBLE_RET
	...
	public ISharedNumericFunctions_Initial<
					...
					NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_COUNT_RET,
					NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_BIGDECIMAL_RET, NO_PARAM_NAMED_DATE_RET,

					NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_COUNT_RET,
					NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_DOUBLE_RET, NO_PARAM_NAMED_BIGDECIMAL_RET, NO_PARAM_NAMED_DATE_RET,
					
					NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_COUNT_RET,
					NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_BIGDECIMAL_RET, NO_PARAM_ALIAS_DATE_RET,
					
					NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_COUNT_RET,
					NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_DOUBLE_RET, NO_PARAM_ALIAS_BIGDECIMAL_RET, NO_PARAM_ALIAS_DATE_RET> sum() {
	...
	public ISharedNumericFunctions_Initial<
				...
				NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_COUNT_RET,
				NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET,
				NO_PARAM_NAMED_SUM_LONG_RET, NO_PARAM_NAMED_COUNT_RET,
				NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET, NO_PARAM_NAMED_COUNT_RET,
				
				NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_COUNT_RET,
				NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET,
				NO_PARAM_ALIAS_SUM_LONG_RET, NO_PARAM_ALIAS_COUNT_RET,
				NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET, NO_PARAM_ALIAS_COUNT_RET
