...
public class MappedWhereOrFunctionGroupByHavingOrderByTest extends GEN_BaseTestCase {
    ...
    @Test
   	public void testMappedMultiAlias() {
	   	...
	   	final MultiBuilt<FarmInfo> query = select.list(FarmInfo.class)
	   			...
	   			.   or().lower(f::getName).isEqualTo("other1")
